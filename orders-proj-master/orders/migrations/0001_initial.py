# Generated by Django 3.0.2 on 2020-02-18 17:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='media/product_images', verbose_name='Фотография')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_comments', models.TextField(blank=True, default=None, null=True, verbose_name='Комментарий к заказу')),
                ('order_status', models.CharField(choices=[('SN', 'Status new'), ('PK', 'Prepare kp'), ('KP', 'Kp'), ('OR', 'Order')], max_length=50)),
                ('date_and_time_of_order', models.DateTimeField(auto_now_add=True, verbose_name='Создан')),
                ('date_and_time_of_change_of_order', models.DateTimeField(auto_now=True, verbose_name='Обновлён')),
                ('products_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orders.Products')),
            ],
            options={
                'verbose_name': 'Заказ',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('MN', 'Manager'), ('CL', 'Client')], max_length=2)),
